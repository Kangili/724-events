...
const Select = ({
  ...
  setValue(newValue);      // met à jour la valeur interne du Select
  onChange(newValue);      // envoie la nouvelle valeur au parent (EventList)
  setCollapsed(true);      // referme la liste après sélection
};
  return (
